  ...
  <div>
    <div class="form-row">
      ...
      <div class="col">
        ...
        <input type="text" id="txt_segundonombre" name="txt_segundonombre" aria-describedby="ayuda_segundo_nombre" class="form-control" v-model="formData.segundonomvre" placeholder="Segundo Nombre">
        ...
        <small id="ayuda_edad_familiar" class="form-text text-muted">Esta es una descripción del campo</small>
        <br />
      ...
      <div class="col">
        ...
        <input type="text" id="txt_segundoapellido" name="txt_segundoapellido" aria-describedby="ayuda_segundo_apellido" class="form-control" v-model="formData.segunsoapellido" placeholder="Segundo Apellido">
        ...
        <input type="number" id="txt_estatura" name="txt_estatura" aria-describedby="ayuda_estatura" class="form-control" v-model="formData.altura" placeholder="Estatura">
...
export default {
  ...
  mounted(){
    //opcionalmente se obtiene  los datos cuando el componente es creado , sin presionar boton
    //this.obtenerDatos();
